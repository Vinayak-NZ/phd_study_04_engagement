...
app_v1_sentiment <- read.csv("data/app_v1_sentiment_count_df.csv")
app_v1_active_data <- read.csv("data/app_v1_active.csv")
app_v1_passive_data <- read.csv("data/app_v1_passive.csv")
app_v1_item_page_match <- read.csv("data/app_v1_item_page_match.csv", sep=",")
...
app_v2_sentiment <- read.csv("data/app_v2_sentiment_count_df.csv")
